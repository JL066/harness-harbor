...
> macOS support is planned but is not currently implemented or validated.
...
GitHub Actions runs the same unit suite on Windows using supported Python versions.
